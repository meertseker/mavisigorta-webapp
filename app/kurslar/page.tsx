...
export const metadata: Metadata = {
  ...
  description: 'Sağlık, kasko, trafik, konut ve işyeri sigortaları. Size uygun sigorta çözümünü seçin. 25 yıllık deneyim.',
};
      ...
      <section className="py-20 bg-gradient-to-br from-primary-red via-primary-red-dark to-accent-burgundy text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Size en uygun sigorta çözümünü seçin ve geleceğinizi güvence altına alın
          </p>
        </div>
      </section>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Size en uygun sigorta çözümünü bulmak için uzman danışmanlarımızla iletişime geçin
          </p>
          <a
            href="/iletisim"
