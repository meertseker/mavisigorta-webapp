...
const PRODUCT_COPY: Record<InsuranceSlug, ProductCopy> = {
  'tamamlayici-saglik': {
    ...
    actionDesc2: 'Allianz TSS teklif süreci',
  ...
  kasko: {
    ...
    actionDesc2: 'Allianz kasko teklifi',
  ...
  konut: {
    ...
    actionDesc2: 'Allianz konut teklifi',
...
function buildSharedSitelinks(slug: InsuranceSlug): SitelinkAsset[] {
  ...
  return [
    ...
    },
    {
      ...
      description2: 'Allianz ürünleri, SSS',
          ...
          ads: [
            {
              ...
              descriptions: [
                '60 saniyede formu doldur, Allianz TSS teklif sürecini Soner Bey başlatsın.',
          ...
          ads: [
            {
              ...
              descriptions: [
                ...
                'Geniş kapsam, özel oda, doğum, check-up, yurt dışı tedavi. Allianz ürünleri için teklif.',
          ...
          ads: [
            {
              ...
              descriptions: [
                ...
                'Bir formla Allianz teklif sürecini başlatıyorsun. Biz 30 dakikada arıyoruz.',
          ...
          ads: [
            {
              ...
              descriptions: [
                'Plakanı yaz, Allianz kasko teklif sürecini Soner Bey takip etsin.',
          ...
          ads: [
            {
              ...
              descriptions: [
                'Plakanı yaz, Allianz trafik sigortası teklif sürecini başlatalım.',
          ...
          ads: [
            {
              ...
              descriptions: [
                'Adresini yaz, Allianz konut sigortası teklif sürecini başlatalım.',
