...
export default function Hero({ title, subtitle, primaryCta, secondaryCta, stats }: HeroProps) {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-800 py-12 md:py-20">
      ...
      <div className="relative container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
          ...
          <motion.div
            ...
            className="md:col-span-8 md:row-span-2 backdrop-blur-2xl bg-white/5 rounded-3xl p-8 md:p-12 border border-white/10 shadow-glass-xl overflow-hidden relative group"
          >
